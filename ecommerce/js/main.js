...
var bike0 = new Bike('Gods Breath', '58cm', 395.00, 'img/bike0.png')

var bike1 = new Bike('Quasimodo', '56cm', 350.00, 'img/bike1.png')

var bike2 = new Bike('Kona', '58cm', 425.00, 'img/bike2.png')

var bike3 = new Bike('Airstream', '56cm', 450.00, 'img/bike3.png')

var bike4 = new Bike('iRobot', '60cm', 400.00, 'img/bike4.png')

var bike5 = new Bike('Barney', '56cm', 495.00, 'img/bike5.png')
...
for(i = 0; i < bikeArray.length; i++) {
	...
	landingImage.setAttribute('src', 'img/landing.jpg')
